...
local globalkeys = gears.table.join(
  ...
  end, { description = "Player Next", group = "hotkeys" }),
  awful.key({ modkey }, "Prior", function()
    awful.spawn("playerctl previous")
  end, { description = "Player Previous", group = "hotkeys" }),
  awful.key({ modkey }, "s", hotkeys_popup.show_help, { description = "show help", group = "awesome" }),
  awful.key({ modkey }, "Return", function()
    awful.spawn(terminal)
  end, { description = "open a terminal", group = "hotkeys" }),
  awful.key({ modkey }, "q", function()
    awful.spawn(browser)
  end, { description = "run browser", group = "hotkeys" }),
  awful.key({ modkey }, "e", function()
    awful.spawn(filemanager)
  end, { description = "run file manager", group = "hotkeys" }),

  awful.key({ modkey }, "r", function()
    awful.spawn("vicinae toggle")
  ...
  end, { description = "dropdown application", group = "hotkeys" }),

  -- Hotkeys: Backlight
  awful.key({}, "XF86MonBrightnessUp", function()
    os.execute("brightnessctl s +10%")
  end, { description = "Increase Screen Brightness", group = "hotkeys" }),
  awful.key({}, "XF86MonBrightnessDown", function()
    os.execute("brightnessctl s 10%-")
  end, { description = "Decrease Screen Brightness", group = "hotkeys" }),
  ...
  -- Hotkeys: Enpass
  awful.key({ ctrlkey, "Shift" }, "\\", function()
    awful.spawn("/opt/enpass/Enpass showassistant")
  end, { description = "Enpass Quick Access", group = "hotkeys" }),
  -- Hotkeys: Htop
  awful.key({ ctrlkey, "Shift" }, "Escape", function()
    awful.spawn(terminal .. " -e htop")
  end, { description = "Htop", group = "hotkeys" }),
  -- Client: Focus
  awful.key(
    { modkey },
    "u",
    awful.client.urgent.jumpto,
    { description = "jump to urgent client", group = "client: switch" }
  ),
  ...
  end, { description = "focus down", group = "client: switch" }),
  awful.key({ modkey }, "k", function()
    awful.client.focus.global_bydirection("up")
    if client.focus then
      client.focus:raise()
    end
  end, { description = "focus up", group = "client: switch" }),
  awful.key({ modkey }, "h", function()
    awful.client.focus.global_bydirection("left")
    if client.focus then
      client.focus:raise()
    end
  end, { description = "focus left", group = "client: switch" }),
  awful.key({ modkey }, "l", function()
    awful.client.focus.global_bydirection("right")
    if client.focus then
      client.focus:raise()
    end
  end, { description = "focus right", group = "client: switch" }),
  awful.key({ modkey }, "Tab", revelation, { description = "window overview", group = "client: switch" }),

  -- Client: layout manipulation
  awful.key({ modkey, "Shift" }, "h", function()
    awful.client.swap.bydirection("left")
  end, { description = "swap with client on the left", group = "client: switch" }),
  awful.key({ modkey, "Shift" }, "j", function()
    awful.client.swap.bydirection("down")
  end, { description = "swap with client below", group = "client: switch" }),
  awful.key({ modkey, "Shift" }, "k", function()
    awful.client.swap.bydirection("up")
  end, { description = "swap with client above", group = "client: switch" }),
  awful.key({ modkey, "Shift" }, "l", function()
    awful.client.swap.bydirection("right")
  end, { description = "swap with client on the right", group = "client: switch" }),
  ...
  end, { description = "focus the next screen", group = "screen: switch" }),
  awful.key({ modkey, "Control" }, "k", function()
    awful.screen.focus_relative(-1)
  end, { description = "focus the previous screen", group = "screen: switch" }),
  ...
  awful.key({ modkey }, "space", function()
    awful.layout.inc(1)
  end, { description = "select next", group = "layout:switch" }),
  awful.key({ modkey, "Shift" }, "space", function()
    awful.layout.inc(-1)
  end, { description = "select previous", group = "layout:switch" }),

  awful.key({ modkey, "Control" }, "h", function()
    awful.tag.incncol(1, nil, true)
  end, { description = "increase the number of columns", group = "layout: modify" }),
  awful.key({ modkey, "Control" }, "l", function()
    awful.tag.incncol(-1, nil, true)
  end, { description = "decrease the number of columns", group = "layout: modify" }),

  awful.key({ altkey, "Shift" }, "l", function()
    awful.tag.incmwfact(0.05)
  end, { description = "increase master width factor", group = "layout: modify" }),
  awful.key({ altkey, "Shift" }, "h", function()
    awful.tag.incmwfact(-0.05)
  end, { description = "decrease master width factor", group = "layout: modify" }),

  awful.key({ modkey, "Control", "Shift" }, "h", function()
    awful.tag.incnmaster(1, nil, true)
  end, { description = "increase the number of master clients", group = "layout: modify" }),
  awful.key({ modkey, "Control", "Shift" }, "l", function()
    awful.tag.incnmaster(-1, nil, true)
  end, { description = "decrease the number of master clients", group = "layout: modify" })
)
...
local clientkeys = gears.table.join(
  ...
  end, { description = "toggle sticky on top", group = "client" }),
...
awful.rules.rules = {
  ...
  {
    rule_any = {
      class = { "vlc", "Lightdm-gtk-greeter-settings", "gnome-calculator", "Evolution-alarm-notify", "Pavucontrol" },
    },
    properties = { floating = true },
  },

  { rule = { modal = true }, properties = { floating = true } },

  { rule = { class = "Bytedance-feishu" }, properties = { floating = true } },
  ...
  { rule = { class = "wechat" }, properties = { focus = false } },

  { rule = { class = "com.alibabainc.dingtalk" }, properties = { focus = false } },

  { rule = { class = "Nextcloud" }, properties = { floating = true } },

  { rule = { class = "digikam", modal = true }, properties = { ontop = true } },

  { rule = { class = "digikam" }, properties = { screen = 1, tag = awful.util.tagnames[3] } },

  { rule = { class = "firefox" }, properties = { screen = 1, tag = awful.util.tagnames[1] } },

  { rule = { class = "Spotify" }, properties = { tag = awful.util.tagnames[6] } },
